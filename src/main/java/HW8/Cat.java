...
public class Cat implements Sportsmens {  //релизация внутри данного класса методов, описанных в указанном интерфейсе
    public String name;
    public  int jump_height; //высота прыжка
    public  int running_endurance; // возможность пробежать

    public Cat(String name, int jump_height, int running_endurance) {
        this.name = name;
